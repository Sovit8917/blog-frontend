            ...
            <div className="flex items-center gap-2.5">
              ...
              {social.twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#000000] text-white shadow-xs transition-all hover:scale-110 hover:-translate-y-0.5 hover:shadow-md hover:shadow-black/30"
              ...
              {social.github && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#24292e] text-white shadow-xs transition-all hover:scale-110 hover:-translate-y-0.5 hover:shadow-md hover:shadow-black/30"
                  aria-label="GitHub"
                >
                  <svg className="h-5 w-5 fill-white" viewBox="0 0 24 24">
