  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 text-xs font-medium text-ink-400 transition hover:text-red-600"
      >
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-bold text-ink-900">Report this job</h2>
              <button onClick={() => setOpen(false)} aria-label="Close" className="rounded-md p-1.5 text-ink-400 hover:bg-ink-50">
                <X size={18} />
              </button>
            </div>
              ...
              <form onSubmit={onSubmit} className="flex flex-col gap-4">
                <label className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    className="rounded-lg border border-ink-200 px-3.5 py-2.5 text-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
                  >
                ...
                <label className="flex flex-col gap-1.5">
                  <span className="text-sm font-medium text-ink-700">Additional details (optional)</span>
                  <textarea
                    value={note}
