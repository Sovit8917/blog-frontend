  ...
  return (
    <div className="container-page flex min-h-[70vh] flex-col items-center justify-center py-16">
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-bold text-ink-900 dark:text-ink-100">Reset your password</h1>
        <p className="mt-1.5 text-sm text-ink-500 dark:text-ink-400">We&apos;ll email you a link to get back in</p>
      </div>
      <Suspense>
        <ForgotPasswordForm />
      </Suspense>
