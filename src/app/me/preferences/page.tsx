    ...
    <div className="container-page flex min-h-[60vh] flex-col items-center py-16">
      <div className="w-full max-w-lg">
        <header className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-ink-900 dark:text-ink-100">Job preferences</h1>
          <p className="mt-1.5 text-sm text-ink-500 dark:text-ink-400">
            Set your location, work style, and skills — we use these to power your{' '}
            <span className="font-medium text-ink-700 dark:text-ink-300">Jobs for you</span> matches.
          </p>
        </header>
