...
export const metadata: Metadata = buildListMetadata({
  ...
  description:
    "Upload your resume to get a quality score, matching open roles, and improvement tips.",
  path: "/me/resume-ats",
});
    ...
    <div className="container-page py-10">
      <header className="mb-8">
        ...
        <p className="mt-2 text-ink-500 dark:text-ink-400">
          Upload your resume to get a quality score, matching open roles, and
          concrete suggestions to improve it.
        </p>
      </header>
      <ResumeAtsAnalyzer />
    </div>
